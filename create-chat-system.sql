-- Create chat system database structure
-- This will enable real-time messaging between clients and tradespeople
...
-- Create chat_notifications table for real-time notifications
...
CREATE INDEX idx_chat_rooms_tradesperson_id ON chat_rooms(tradesperson_id);
...
CREATE INDEX idx_chat_notifications_user_type ON chat_notifications(user_type);
...
UNION ALL
SELECT 'chat_notifications' as table_name, COUNT(*) as row_count FROM chat_notifications; 